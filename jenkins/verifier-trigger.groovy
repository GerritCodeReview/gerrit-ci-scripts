...
static class Globals {
    final def gerrit = "https://gerrit-review.googlesource.com/"
    final def maxChanges = 500
    final def pollMinutes = 5
    final def tsFormat = new SimpleDateFormat("YYYY-MM-dd HH:mm:ss.S Z")
    final def hookUrl = "${env.JENKINS_URL}gerrit-webhook/"
}

...
class Globals {
  ...
  static Set<String> codeStyleBranches = ["master", "stable-3.1", "stable-3.0", "stable-2.16", "stable-2.15", "stable-2.14"]
...
def buildChange(change) {
  ...
  if(branch == "master" || branch == "stable-3.1" || branch == "stable-3.0") {
    modes = ["notedb"]
  }

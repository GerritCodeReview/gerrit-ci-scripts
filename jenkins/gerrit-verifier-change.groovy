...
class Gerrit {
  ...
  def addCodeStyleLabel(cs, files) {
    if(cs == 0) {
      return
    }
...
node('master') {
    ...
    stage('Vote'){
        if(Builds.resultCodeStyle) {
            ...
            gerrit.addCodeStyleLabel(resCodeStyle, findCodestyleFilesInLog())
        }
        ...
        gerrit.addVerifiedLabel(resVerify)

...
def gerritQuery = "status:open project:gerrit (branch:stable-2.15 OR branch:stable-2.16 OR branch:stable-3.0 OR branch:stable-3.1 OR branch:master) since:\"" + since + "\""

...
then
  ...
  bazelisk build --config=remote_bb --remote_header=x-buildbuddy-api-key={BB_API_KEY} --remote_instance_name=projects/gerritcodereview-ci/instances/default_instance plugins:core release api-skip-javadoc

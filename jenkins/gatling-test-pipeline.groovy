...
pipeline {
       ...
       environment {
            ...
            GERRIT_HTTP_URL = String.format("%s://%s", "${params.GERRIT_HTTP_SCHEMA}", HTTP_PRIMARIES_GERRIT_SUBDOMAIN)
            GERRIT_SSH_URL = String.format("ssh://%s@%s", "${params.GERRIT_SSH_USERNAME}", SSH_PRIMARIES_GERRIT_SUBDOMAIN)
         }

                    ...
                    dir ('gerrit') {
                        script {
                            ([pluginName] + extraPlugins + extraModules + extraGhRepos).each { plugin ->
                                ...
                                sh "if [ -f ../${plugin}/external_plugin_deps.MODULE.bazel ]; then echo 'include(\"//plugins/${plugin}:external_plugin_deps.MODULE.bazel\")' >> plugins/external_plugin_deps.MODULE.bazel; fi"
                            }
                        }

            ...
            stage('build') {
                ...
                steps {
                    ...
                    dir ('gerrit') {
                        ...
                        sh ". set-java.sh ${javaVersion} && bazelisk build ${bazelOpts} plugins/${pluginName}"
                        sh ". set-java.sh ${javaVersion} && bazelisk test ${bazelOpts} --test_env DOCKER_HOST=" + '$DOCKER_HOST' + " plugins/${pluginName}/..."
                    }
                }
        }
    }

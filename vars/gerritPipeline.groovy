...
def collectBuildModes() {
    ...
    def onlyPolygerritChanges = !polygerritFiles.isEmpty() && changedFiles.size() == polygerritFiles.size() && bazelFiles.isEmpty()

    // polygerrit verification on master branch happens elsewhere

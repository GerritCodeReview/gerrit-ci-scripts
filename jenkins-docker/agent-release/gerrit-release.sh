...
then
  ...
  echo "* OSSHR_USER:"
  echo "     OSS Repository Hosting username for manual upload, used to upload artifacts to maven central"
  echo "* OSSHR_TOKEN:"
  echo "     OSS Repository Hosting token for manual upload, used to upload artifactd to maven central"
  echo ""
  exit 1
fi
